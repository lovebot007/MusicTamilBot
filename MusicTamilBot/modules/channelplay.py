# MusicTamilBot (Telegram bot project)
...
from MusicTamilBot.modules.play import generate_cover
from MusicTamilBot.modules.play import arq
from MusicTamilBot.modules.play import cb_admin_check
from MusicTamilBot.modules.play import transcode
from MusicTamilBot.modules.play import convert_seconds
from MusicTamilBot.modules.play import time_to_seconds
from MusicTamilBot.modules.play import changeImageSize
from MusicTamilBot.config import BOT_NAME as bn
from MusicTamilBot.config import DURATION_LIMIT
from MusicTamilBot.config import UPDATES_CHANNEL as updateschannel
from MusicTamilBot.config import que
from MusicTamilBot.function.admins import admins as a
from MusicTamilBot.helpers.errors import DurationLimitError
from MusicTamilBot.helpers.decorators import errors
from MusicTamilBot.helpers.admins import get_administrators
from MusicTamilBot.helpers.channelmusic import get_chat_id
from MusicTamilBot.helpers.decorators import authorized_users_only
from MusicTamilBot.helpers.filters import command
from MusicTamilBot.helpers.filters import other_filters
from MusicTamilBot.helpers.gets import get_file_name
from MusicTamilBot.services.callsmusic import callsmusic
from MusicTamilBot.services.callsmusic import client as USER
from MusicTamilBot.services.converter.converter import convert
from MusicTamilBot.services.downloaders import youtube
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/0d5d3f1e0ddafb295ef46.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @soulmusictamil to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/0d5d3f1e0ddafb295ef46.jpg"
